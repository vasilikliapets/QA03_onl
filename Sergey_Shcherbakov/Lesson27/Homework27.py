...
cursor = db.cursor()
# cursor.execute("CREATE TABLE orders (ord_no INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, purch_amt FLOAT(11), "
#                "ord_date VARCHAR(255), customer_id INT(11), salesman_id INT(11))")
