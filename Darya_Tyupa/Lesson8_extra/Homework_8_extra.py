...
result = lambda x: sorted(x)[::-1]
print(result(li))

# 3 Реализуйте лямбда функцию, которая проверяет есть ли в слове буква 't', и отфильтруйте список имен с помощью функции filter

names = ['Kate', 'Maria', 'Nikita', 'Tanya']
