...
empty = False
print(empty in a.values()) # 5.3 Проверка есть ли пустые либо =0 значения в а

print(all(b.values())) #5.4 Проверить что есть хотя бы одно пустое значение

print(sorted(a.items(), reverse = True)) #5.5 Сортиврока по алфавиту в обратном порядке
